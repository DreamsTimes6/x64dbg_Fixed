...
typedef void (*DBGPROCESSPENDINGCOMMANDS)();
typedef bool (*DBGSCRIPTISRUNNING)();
...
typedef bool (*DBGGETREGVALUE)(int reg, duint* value);
typedef bool (*DBGSETREGVALUE)(int reg, duint value);
...
extern DBGPROCESSPENDINGCOMMANDS _dbg_processpendingcommands;
extern DBGSCRIPTISRUNNING _dbg_scriptisrunning;
...
extern DBGGETREGVALUE _dbg_getregvalue;
extern DBGSETREGVALUE _dbg_setregvalue;
